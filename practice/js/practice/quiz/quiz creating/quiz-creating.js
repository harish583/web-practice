...
function Deleting(i) {
    ...
    var id = encodeURI( quat[i].innerHTML.replace(/ /g,''));
...
function update(i) {
    ...
    var id = encodeURI( quat.value.replace(/ /g,''));
...
function renderingHtmlEditingQuation(Quations,event){
    ...
    '<div class="popup-content">'+
        ...
        var close = '<input type="number" class="correct-option" value="'+Quations[id].correct+'">'+
