...
function renderingHtml(){
    ...
    for(var i =0;i<Employees.length;i++){
        var htmlStudentList = htmlStudentList +'<li class="student-info" data-id ="'+i+'">'+
        ...
        '<div class="inline View-details" data-id ="'+i+'">view details'+i+'</div>'+
        '<div class="inline Edit-button" data-id ="'+i+'">edit'+i+'</div>'+
        '<div class="inline Delete-button" data-id ="'+i+'">delete'+i+'</div>'+
    '</li>'
...
function conformationToDelete(event){
    ...
    var x = document.querySelectorAll(".student-info");
...
function deleteEmployee(event){
    ...
    '<div class="verification" data-id="'+i+'">ok,accept to delete</div>';
