...
import './index.css';
import { response, fileUpload }from '../ajaxRequest/request';
...
export default class HomeComponents extends React.Component{
    ...
    clicked=(e)=>{
        ...
        if(enteredCustomData){
            ...
            if(a){
                ...
                //if(this.props.textcontent.status){
                  //  console.log(this.props.textContent+"jjjj");
                //}
            }
        }
    }
    ...
    fileHandler=(e)=>{
        ...
        //     }
        // }
        var urls = this.props.textcontent[0].customData.data;
        //console.log("urls ", this, this.props, this.props.textcontent);
        debugger;
        ...
        for(var e in urls){
            if(urls[e].type=="FILES"){
                var key = urls[e].controlData.uploadKey;
                var uploadUrl = urls[e].controlData.uploadUrl;
                a.uploadKey=key;
